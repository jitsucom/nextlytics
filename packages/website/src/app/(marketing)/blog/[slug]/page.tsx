...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const ogImage = `https://nextlytics.dev/og/blog/${slug}`;
    ...
    "@graph": [
      {
        ...
        image: `https://nextlytics.dev/og/blog/${slug}`,
        author: {
          "@type": "Organization",
          name: "Nextlytics",
        ...
        mainEntityOfPage: `https://nextlytics.dev/blog/${slug}`,
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Nextlytics", item: "https://nextlytics.dev" },
          { "@type": "ListItem", position: 2, name: "Blog", item: "https://nextlytics.dev/blog" },
